...
Route::match(['get', 'post'], '/mortgage/interest/payment/midtrans/notification', 
    [DashboardController::class, 'paymentMidtransNotification'])
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:customer')->group(function() {
        ...
        Route::get('/dashboard/mortgage/{mortgageRequest}/installments/payment', 
        [DashboardController::class, 'installment_payment'])->name('dashboard.installment.payment');

        Route::post('/dashboard/mortgage/installments/payment', 
        [DashboardController::class, 'paymentStoreMidtrans'])->name('dashboard.installments.payment.payment_store_midtrans');
        ...
        Route::get('/dashboard/mortgage/installment/{installment}', [DashboardController::class, 
        'installment_details'])->name('dashboard.installment.details');
    });
});
