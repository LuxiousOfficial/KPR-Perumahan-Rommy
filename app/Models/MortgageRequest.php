...
class MortgageRequest extends Model
{
    ...
    protected $fillable = ['user_id', 'house_id', 'duration', 'bank_name', 'interest', 'interest_id',
                            'dp_total_amount', 'loan_total_amount', 'monthly_amount', 
                            'dp_percentage', 'status', 'document', 'house_price', 
