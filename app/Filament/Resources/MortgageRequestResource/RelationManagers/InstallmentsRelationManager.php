                ...
                Forms\Components\Wizard::make([
                    ...
                    ->schema([
                        ...
                        ->afterStateUpdated(function ($state, callable $get, callable $set) {
                            ...
                            $set('insurance_total_amount', $insurance);
                        ...
                        Forms\Components\TextInput::make('insurance_total_amount')
                    ...
                    Forms\Components\Wizard\Step::make('Payments')
                    ->schema([
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('insurance_total_amount'),
