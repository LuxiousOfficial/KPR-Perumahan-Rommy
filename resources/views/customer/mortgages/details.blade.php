        ...
        <div class="h-screen w-full overflow-y-auto pt-[30px] px-[30px]">
            ...
            <main class="flex w-full flex-col justify-center gap-[30px] pt-[28px] pb-[70px]">
                <header class="flex flex-col gap-[6px]">
                    ...
                    <p class="text-sm leading-[21px] text-tedja-secondary">Rommy Ardiansyah always make your family comfortable</p>
                </header>
                    ...
                    <div class="flex items-center gap-4 pr-5">
                        ...
                        <div class="flex flex-col gap-5 w-full">
                            <section id="Title" class="flex items-center justify-between">
                                ...
                                <span class="bg-tedja-orange rounded-full text-white py-[6px] px-[10px] font-semibold">Waiting for Bank</span>
                                        ...
                                        <section id="KPRPaymentDetails" class="border border-[#F2F2F4] p-5 rounded-[20px] flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">Rp {{ number_format($mortgageRequest->dp_total_amount, 0, '', '.') }} {{ $mortgageRequest->dp_percentage }}%</strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                        <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-bold text-[20px] leading-[30px] text-tedja-blue">Rp {{ number_format($mortgageRequest->loan_interest_total_amount, 0, '', '.') }}</strong>
                                                </div>
                                            </div>
                                        </section>
                                    </div>
                                        ...
                                        <section id="BankKPRDetails" class="border border-[#F2F2F4] p-5 rounded-[20px] flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">{{ $mortgageRequest->interestModel->interest }}%</strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                        <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                                    ...
                                    <div class="flex flex-col gap-5">
                                        ...
                                        <div class="flex items-center justify-between p-[10px] rounded-[30px] border border-[#F2F2F4]">
                                            ...
                                            <div class="flex flex-col gap-[2px]">
                                                ...
                                                <strong class="font-bold">{{ $installment->created_at->format('d M, Y') }}</strong>
                                            </div>
