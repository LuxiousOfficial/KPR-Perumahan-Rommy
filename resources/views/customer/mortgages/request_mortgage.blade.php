<x-layout>
    ...
    <div class="flex justify-center gap-[30px] mt-[50px] mb-[70px]">
        ...
        <div class="flex flex-col gap-5 w-[500px] shrink-0">
                ...
                <div class="flex flex-col gap-4" id="PriceDetails">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold">Free Security</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
            ...
            <form action="{{ route('front.interest.submitted') }}" enctype="multipart/form-data" method="POSt" id="Request-Mortage" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-5">
                @csrf
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <label id="Input-File-Trigger" type="button" class="relative flex items-center rounded-full border border-tedja-black py-[14px] px-5 gap-[10px]">
                        ...
                        <input required type="file" name="document" id="File-Input" class="absolute opacity-0">
                    </label>
                </div>
                <hr class="border-[#F2F2F4]">
                ...
                <hr class="border-[#F2F2F4]">
                <button type="submit" name="submit" class="rounded-full py-[14px] px-5 bg-tedja-green w-full text-center font-semibold">Request for Mortgage Now</button>
            </form>
        </div>
    </div>
