        ...
        <div class="h-screen w-full overflow-y-auto pt-[30px] px-[30px]">
            ...
            <main class="flex w-full flex-col justify-center gap-[30px]  py-[28px]">
                ...
                <section id="Cards" class="flex flex-col gap-[30px]">
                    ...
                    <div class="card flex items-center gap-[12px] pt-[10px] pb-5 bg-white border border-[#F2F2F4] px-[10px] rounded-[30px]">
                        ...
                        <div class="px-[10px] flex flex-col gap-[18px] w-full">
                            <div class="title flex flex-col gap-[6px]">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->city->name }}</p>
                                </div>
                            </div>
                            <div class="points grid grid-cols-3 gap-x-[18px] gap-y-[12px]">
                                <div
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->bedroom }} Bedroom</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/building.svg') }}" alt="icon" class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->building_area }} M²</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/note-favorite.svg') }}" alt="icon" class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->certificate }}</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/slider-horizontal.svg') }}" alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->bathroom }} Bathroom</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/maximize.svg') }}" alt="icon" class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->land_area }} M²</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/flash.svg') }}" alt="icon" class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgage->house->electric }} Watts</p>
                                </div>
                            </div>
                        </div>
                    ...
                    @empty
                    <h2>Anda belum mengajukan apapun disini</h2> 
                    @endforelse
                </section>
