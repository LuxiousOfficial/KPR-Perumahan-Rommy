<x-dashboard>
                                ...
                                <div class="flex flex-col gap-4" id="KPRPaymentDetailsJ">
                                    ...
                                    <div class="flex flex-col gap-4">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <strong class="font-semibold">Rp {{ number_format($remainingLoanAmount) }}</strong>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon"
                                            ...
                                            <strong class="font-semibold">Rp {{ number_format($monthlyPayment) }}</strong>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon"
                                            ...
                                            <strong class="font-semibold">Rp {{ number_format($totalTaxAmount) }}</strong>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon"
                                            ...
                                            <strong class="font-semibold">Rp {{ number_format($insurance) }}</strong>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon"
                                            ...
                                            <input type="text" id="grandTotal" name="grandTotal" value="{{ number_format($grandTotalAmount) }}"
                                                readonly
    ...
    <script type="text/javascript">
        ...
        payButton.addEventListener('click', function(e) {
            ...
            fetch('{{ route('dashboard.installments.payment.payment_store_midtrans') }}', {
                        method: "POST",
                        headers: {
