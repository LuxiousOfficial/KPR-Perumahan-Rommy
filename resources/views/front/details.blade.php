<x-layout>
    ...
    <div class="mt-[164px] flex flex-col gap-5 text-center items-center">
        <p class="flex items-center gap-[6px] rounded-full py-[6px] px-3 bg-white border border-tedja-border">
            ...
            <span class="font-semibold text-sm">Top Well-Designed House by Rommy</span>
        </p>
        ...
        <div class="flex items-center justify-center gap-5">
            <div class="flex items-center gap-[6px]">
                ...
                <p class="font-semibold">{{ $houseDetails->city->name }}</p>
            </div>
            <div class="flex items-center gap-[6px]">
    ...
    <!-- Modal -->
    <div id="Gallery-Modal" class="fixed inset-0 items-center justify-center bg-tedja-black/50 z-30 hidden">
